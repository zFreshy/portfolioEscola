...
var readI53FromI64 = function readI53FromI64(ptr) {
...
var FBinner = {
  ...
  http_callback: function http_callback(xmlhttp, callback, lua_callback, products, product_ids, product_count, url_index, url_count) {
    if (xmlhttp.readyState == 4) {
      ...
      if (url_index == product_count - 1) {
        ...
        getWasmTableEntry(callback)(lua_callback, res_buf);
      } else {
...
function _dmIAPFBBuy(param_product_id, param_request_id, callback, lua_callback) {
  ...
  FB.ui(buy_params, function (response) {
    if (response && response.status) {
      ...
      var res_buf = stringToUTF8OnStack(productsJSON);
      getWasmTableEntry(callback)(lua_callback, res_buf, 0);
    } else {
      var reason;
      ...
      getWasmTableEntry(callback)(lua_callback, 0, reason);
    }
  });
}
function _dmIAPFBList(params, callback, lua_callback) {
...
function _screenshot_on_the_next_frame(callback, x, y, w, h) {
  ...
  window.requestAnimationFrame = function (f) {
    ...
    setTimeout(function () {
      getWasmTableEntry(callback)(img_buf, w, h);
      _free(img_buf);
    }, 0);
...
var wasmImports = {
  b: ___assert_fail,
  Xh: ___syscall__newselect,
  Wh: ___syscall_accept4,
  Vh: ___syscall_bind,
  Uh: ___syscall_chdir,
  Th: ___syscall_connect,
  Sh: ___syscall_dup3,
  h: ___syscall_fcntl64,
  Rh: ___syscall_getcwd,
  Qh: ___syscall_getdents64,
  ...
  Dh: ___syscall_symlink,
  X: ___syscall_unlinkat,
  Ch: ___syscall_utimensat,
  zh: __emscripten_get_now_is_monotonic,
  yh: __emscripten_lookup_name,
  xh: __emscripten_system,
  wh: __emscripten_throw_longjmp,
  Da: __gmtime_js,
  Ca: __localtime_js,
  Ba: __mktime_js,
  vh: __tzset_js,
  g: _abort,
  uh: defos_set_cursor_locked_,
  ...
  ih: _dmSysOpenURL,
  ra: _emscripten_asm_const_double,
  ...
  Wb: _glColorMask,
  F: _glCompileShader,
  o: _glCompressedTexImage2D,
  ma: _glCompressedTexImage3D,
  n: _glCompressedTexSubImage2D,
  ...
  _a: _glfwGetMouseLocked,
  Za: _glfwGetMousePos,
  Ya: _glfwGetMouseWheel,
  Xa: _glfwGetWindowParam,
  Wa: _glfwGetWindowRefreshRate,
  ba: _glfwGetWindowSize,
  Va: _glfwIconifyWindow,
  Ua: _glfwInitJS,
  aa: _glfwOpenWindow,
  z: _glfwOpenWindowHint,
  Ta: _glfwPollEvents,
  Sa: _glfwResetKeyboard,
  Ra: _glfwSetCharCallback,
  Qa: _glfwSetDeviceChangedCallback,
  Pa: _glfwSetGamepadCallback,
  Oa: _glfwSetMarkedTextCallback,
  Na: _glfwSetTouchCallback,
  Ma: _glfwSetWindowBackgroundColor,
  ...
  r: invoke_viiiii,
  a: wasmMemory,
  ya: _screenshot_on_the_next_frame,
  xa: _strftime,
  wa: _strftime_l
};
var wasmExports = createWasm();
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Yh"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Zh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["_h"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["$h"])(a0);
};
...
var _defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = function (a0) {
  return (_defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = wasmExports["ci"])(a0);
};
...
var ___start_em_js = Module["___start_em_js"] = 316473;
var ___stop_em_js = Module["___stop_em_js"] = 316868;
