...
, function(t, e, n) {
    ...
    function gt(t) {
        ...
        u.default)(t, ["store", "computedStyle"]), c = o.element, s = o.actionItem, f = o.immediate, l = o.pluginInstance, d = o.continuous, p = o.restingValue, v = o.eventId, h = !d, E = D(), g = r.getState(), m = g.ixElements, T = g.ixSession, O = g.ixData, b = L(m, c), A = (m[b] || {}).refState, S = I.getRefType(c), w = T.reducedMotion && _.ReducedMotionTypes[s.actionTypeId];
        if (w && d)
...
, function(t, e, n) {
    var r, i, o, a = n(139), u = n(3), c = n(24), s = n(17), f = n(16), l = n(71), d = n(39), p = u.WeakMap;
    if (a) {
        var v = new p
          , h = v.get
          , E = v.has
...
, function(t, e, n) {
    ...
    function gt(t) {
        ...
        var N, C, x, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || b] || {}, M = Boolean(L.id || L.selector), P = o && l(_t(o.target));
...
, function(t, e, n) {
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        null == _ && (E = 1,
        _ = c);
        var g, I, m, T, O = Math.max(_, 0) || 0, b = v(O - n), A = l ? d : v(n + b * E), S = 100 * A;
        if (A === n && t.current)
            return t;
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a97b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-2": {
            ...
            "target": {
                ...
                "originalId": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a97c",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".sticky-banner",
        ...
        "e-4": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a982",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".scroll-track-2",
                "originalId": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a989",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "id": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a989",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            }],
            "config": [{
        ...
        "e-6": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "6145af65492cb67b809e4003|8eda06c2-4a1d-0780-d544-49ca6b58a990",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
            ...
            "createdOn": 1589158785168
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "scroll-track-2",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".sticky-banner",
                                "selectorGuids": ["2ce0d103-68cd-74ce-88e6-b5b1454dc6c1"]
                            },
                            "xValue": 1,
                            "yValue": 1,
                            "locked": true
        ...
        "a-2": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["2ce0d103-68cd-74ce-88e6-b5b1454dc6c5"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".h3-00",
                            "selectorGuids": ["2ce0d103-68cd-74ce-88e6-b5b1454dc6c4"]
                        },
                        "yValue": 100,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "createdOn": 1589155549317
        },
        "a-3": {
            "id": "a-3",
            "title": "banner-scroll-out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    "actionTypeId": "STYLE_OPACITY",
